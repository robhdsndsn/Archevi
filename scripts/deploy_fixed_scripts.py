#!/usr/bin/env python3
"""Deploy all fixed tenant scripts to Windmill"""
import requests
...
# Scripts to deploy with their paths
scripts = [
    {
        "file": "get_user_tenants.py",
        "path": "f/tenant/get_user_tenants",
        "summary": "Get user's accessible tenants",
        "description": "Returns all tenants (families) a user has access to"
    },
    {
        "file": "provision_tenant.py",
        "path": "f/tenant/provision_tenant",
        "summary": "Provision new tenant",
        "description": "Creates a new tenant and sets up initial configuration"
    },
    {
        "file": "provisioning_worker.py",
        "path": "f/tenant/provisioning_worker",
        "summary": "Process provisioning queue",
        "description": "Processes pending tenant provisioning tasks"
    },
    {
        "file": "switch_tenant.py",
        "path": "f/tenant/switch_tenant",
        "summary": "Switch user tenant context",
        "description": "Updates user's active tenant and returns new JWT"
    },
    {
        "file": "invite_to_tenant.py",
        "path": "f/tenant/invite_to_tenant",
        "summary": "Invite user to tenant",
        "description": "Creates an invitation for a user to join a family"
    },
]

print("=" * 60)
print("Deploying fixed tenant scripts to Windmill")
print("=" * 60)
