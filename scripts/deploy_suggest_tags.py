...
script = {
    ...
    "summary": "AI tag and category suggestions",
    "description": "Get AI-powered tag and category suggestions for documents before embedding"
}

print("=" * 60)
print("Deploying suggest_tags script")
print("=" * 60)
