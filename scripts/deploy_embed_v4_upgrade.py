#!/usr/bin/env python3
"""Deploy scripts with Cohere Embed v4 upgrade"""
import requests
...
# Scripts updated to Embed v4
scripts = [
    {
        "file": "search_documents.py",
        "path": "f/chatbot/search_documents",
        "summary": "Semantic document search (Embed v4)",
        "description": "Semantic search using Cohere Embed v4 with 1024-dimension vectors"
    },
    {
        "file": "search_documents_advanced.py",
        "path": "f/chatbot/search_documents_advanced",
        "summary": "Advanced document search (Embed v4)",
        "description": "Advanced search with filters using Cohere Embed v4"
    },
    {
        "file": "bulk_upload_documents.py",
        "path": "f/chatbot/bulk_upload_documents",
        "summary": "Bulk document upload (Embed v4)",
        "description": "Batch document embedding using Cohere Embed v4"
    },
]

print("=" * 60)
print("Deploying Cohere Embed v4 Upgrade")
print("=" * 60)
...
print("=" * 60)
print("\nNote: All scripts now use Cohere Embed v4 with 1024-dimension Matryoshka embeddings")
