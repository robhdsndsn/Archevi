#!/usr/bin/env python3
"""Deploy scripts that were missing dependencies in their lock files"""
import requests
...
# Scripts that had missing dependencies
scripts = [
    {
        "file": "get_conversation_history.py",
        "path": "f/chatbot/get_conversation_history",
        "summary": "Get conversation history",
        "description": "Retrieve past conversations from the chatbot"
    },
    {
        "file": "bulk_upload_documents.py",
        "path": "f/chatbot/bulk_upload_documents",
        "summary": "Bulk upload documents",
        "description": "Batch document embedding and storage"
    },
    {
        "file": "embed_document_enhanced.py",
        "path": "f/chatbot/embed_document_enhanced",
        "summary": "Enhanced document embedding",
        "description": "Document embedding with AI-powered auto-categorization, smart tags, and expiry detection"
    },
]

print("=" * 60)
print("Deploying scripts with fixed dependency lock files")
print("=" * 60)
