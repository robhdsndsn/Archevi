...
export interface ApiAnnouncementAnnouncement
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    display_location: Schema.Attribute.Enumeration<
      ['Everywhere', 'Home', 'Pricing', 'Features', 'Blog', 'FAQ', 'Dashboard']
    > &
      Schema.Attribute.DefaultTo<'Everywhere'>;
    ...
    target_roles: Schema.Attribute.Enumeration<
      ['All', 'OlderAdult', 'Volunteer', 'Family']
    > &
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['News', 'Updates', 'Features', 'Community']
    > &
...
export interface ApiChangelogChangelog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Version release notes and changelog entries';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    is_major: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Getting Started', 'Messaging', 'Account', 'Privacy', 'Technical']
    > &
      Schema.Attribute.DefaultTo<'Getting Started'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    is_published: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiFeatureFeature extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Core', 'AI', 'Security', 'Collaboration']
    > &
...
export interface ApiLegalPageLegalPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    last_updated: Schema.Attribute.Date & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
